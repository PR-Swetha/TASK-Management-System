...
#### *Built with Spring Boot and Angular 7 web application for task management .*
## Demo
...
- GOTO the path of **frontend** folder in comand-prompt and run `npm start`  because i have configured different port number for frontend.
